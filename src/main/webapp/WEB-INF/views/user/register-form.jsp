                    ...
                    <div class="form-main-content" style="width:750px; margin: 0 auto;">
                        ...
                        <form action="${pageContext.request.contextPath}/register" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" class="register-input" id="confirm-password" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="referral-code">
                                <input type="text" class="btn-input" id="referral-code" name="referral-code" placeholder="추천인 코드">
                                <button type="button" class="btn-init" id="btm-referral-code" style="background: #a8a8a8;">조회
                                </button>
                            </div>
