            ...
            <div class="col-md-7">
                ...
                <form>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control non-btn-input" id="name" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <button type="button" class="btn-init green" id="overlapCheck">중복확인</button>
                    </div>
                    <p class="register-comment">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" id="email" placeholder="예: greating@hyundai.com" required>
                        <button type="button" class="btn-init green" id="overlapCheck">중복확인</button>
                    </div>
                    <p class="register-comment" style="color: #918c00">
                        ＊ 맞춤상품 추천 및 Hpoint 서비스 이용을 위해 생년월일과 성별을 정확히 입력해 주세요.
                    </p>
                    <div class="form-group">
                        <label for="birth">생년월일</label>
                        <input type="birth" class="form-control" id="birth" placeholder="예: 20010415" required>
                    </div>
                    <div class="form-group">
                        <label>성별</label>
                    ...
                    <p class="favor-choice">
                        아래 보기 중 선택하시면 <span style="font-weight: bold">스푼 포인트 100개</span>를 드려요!
                    </p>
                    ...
                    <hr>
                    <p class="favor-choice">
                        추천인 코드를 입력하시고 첫 구매를 확정하시면 고객님과 추천인 모두에게 <span style="font-weight: bold">스푼 포인트</span>를 드려요!<br>
                        <span style="font-size: 11px; color: #888">(지급되는 스푼 포인트는 이벤트 내용에 따라 달라질 수 있습니다)</span>
                    </p>
                    <div class="referral-code">
                        <input type="text" class="form-control" id="referral-code" name="referral-code" placeholder="추천인 코드">
                        <button type="button" class="btn-init" id="btm-referral-code" style="background: #a8a8a8;">조회</button>
                    </div>
                    <div class="button-container">
                        <button class="left-button">취소</button>
                        <button class="right-button">제출</button>
                    </div>
