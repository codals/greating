				    ...
				    <div class="gnb__inner">
				      <div class="swiper-container">
				        <div class="swiper-wrapper">
				          <li class="gnb__list"><a href="/planMeals/healthyMeals" class="gnb__list-name L-Affiliate-Tagged">건강식단</a></li>
				          <li class="gnb__list"><a href="/planMeals/planMeals" class="gnb__list-name L-Affiliate-Tagged">질환맞춤식단</a></li>
				          <li class="gnb__list"><a href="/planMeals/challenge" class="gnb__list-name L-Affiliate-Tagged">챌린지식단</a></li>
				          <li class="gnb__list"><a href="/planMeals/mealDIY" class="gnb__list-name L-Affiliate-Tagged">DIY 식단</a></li>
				          <li class="gnb__list"><a href="/event/eventList?targetMenuType=1" class="gnb__list-name L-Affiliate-Tagged">이벤트</a></li>
				          <li class="gnb__list"><a href="/story/reviewMain" class="gnb__list-name L-Affiliate-Tagged">리뷰</a></li>
				          <li class="gnb__list"><a href="/story/guideMain" class="gnb__list-name L-Affiliate-Tagged">이용방법</a></li>
				        </div>
				      </div>
				    </div>
				  </div>
