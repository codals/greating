...
<html>
<head>
<link href="/greating/resources/css/order/order-step1.css" rel="stylesheet">
<style type="text/css">
...
<body>
	...
	<div class="main-content hd__inner1100">
		...
		<!-- 설계하기및 현재 단계 -->
		<h2 class="meals__title"><span>설계하기</span></h2>
        ...
        <section class="meals-area1">
            <div class="meals-area_div">
                <h2 class="meals-area_div_title"><span>식단관리 기간을 선택하세요.</span></h2>
        ...
        <section class="meals-area2 weektype">
               <div class="meals-area_div" id="weekend">
                   <h2 class="meals-area_div_title"><span>일주일에 몇 끼를 드실건가요?</span> <span class="meals-area__cont__desc">(주 6일 기준)</span></h2>
         ...
         <div class="meals-final">
             <h3><span class="meals-final__head">총 선택 끼니 수</span></h3>

             <p class="meals-final__cont">
                <h1 class="h1 meals-area_div_title"><span class="meals-final__cont__num" data-total-count="0">0</span>끼</h1>
			 </p>
         </div>
         ...
         <div class="meals-btn">
	          ...
	          <a href="#" class="btn-init white normal"><p class="meals-span" id="next_text">선택을 완료해주세요</p></a>
         </div>
         </form>
